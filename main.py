    ...
    while True:
        ...
        if unboxing_in_progress:
            if find_and_click_button(open_drop_image):
                ...
                if find_and_click_button(confirm_button_image):
                    ...
                    if find_and_click_button(ok_button_image, timeout=unbox_delay):
                        ...
                        print("[WARNING] 'OK' button not found. Checking for 'Back' button...")

                        if find_and_click_button(back_button_image):
                            print("[ACTION] Clicked 'Back'. Returning to home screen.")
                            unboxing_in_progress = False
                            continue
                else:
                    print("[WARNING] 'Confirm' button not found. Skipping this drop.")
            else:
                print("[WARNING] 'Open Drop' button not found. Exiting.")
                unboxing_in_progress = False
                break
